...
public class CardController extends ControllerBase {
    ...
    public String list()
    {
        ...
        GenericHelper.GetResult(session,"From MembershipCard");
        msg=SUCCESS;
    ...
    public String modify(Integer MembershipCardID,Integer levelID,double fund)
    {
        ...
        MemberShipCardLevel level = (MemberShipCardLevel)session.get(MemberShipCardLevel.class,levelID);
        try {
            MemberShipCard card = session.get(MemberShipCard.class,MembershipCardID);
            card.setFund(fund);
    ...
    public String get(Integer userID)
    {
        ...
        try
        {
            card = GenericHelper.<MemberShipCard>GetResult(session,String.format(format,userID))
            .get(0);
            msg=SUCCESS;
            result=card;
        }
