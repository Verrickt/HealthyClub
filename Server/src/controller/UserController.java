...
public class UserController extends ControllerBase {
    ...
    public String modify(Integer userID,String name, String email, Integer age, String gender,
                           String phoneNumber, String password) {
        String msg = "";
    ...
    public String list()
    {
        ...
        String msg = null;
        List<User> users = GenericHelper.GetResult(session,"From User order by ID");
        msg=SUCCESS;
        result=users;
