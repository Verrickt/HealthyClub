...
public class EmployeeController extends ControllerBase
{
    ...
    public String login(String username,String password)
    {
        ...
        try
        {
            employee = GenericHelper.<Employee>GetResult(session,String.format(format,username)).get(0);
                         ...
                         Integer authority,String jobTitle)
    {
        ...
        Employee result = null;
        Employee employee =
                new Employee(email,gender,age,jobTitle,name,password,authority);
    ...
    {
        String msg = FAIL;
        List<Employee> employees = GenericHelper.GetResult(session,"From Employee");
        msg=SUCCESS;
        return new ResponseBuilder<List<Employee>>(msg,employees).toString();
    }
    public String modify(Integer employeeID,String name, String email, Integer age, String gender,
                         String phoneNumber, String password,
                         Integer authority,String jobTitle)
    {
        String msg = null;
