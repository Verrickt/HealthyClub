...
public class DedicatedServiceController extends ControllerBase{
    ...
    public String List(Integer TechnicianID)
    {
        ...
        List<DedicatedService> services = GenericHelper.<DedicatedService>GetResult(session,hql);
        msg=SUCCESS;
        return new ResponseBuilder<List<DedicatedService>>(msg,result).toString();
    }
    public String Create(Integer serviceID,Integer techinicianID,double price)
    {
        ...
        Technician t = (Technician) session.get(Technician.class,techinicianID);
        ...
        catch (Exception e)
        {
            ...
            return new ResponseBuilder<DedicatedService>(msg,result).toString();
        }
    }
    ...
    public String Remove(Integer dedicatedServiceID)
    {
       String msg = "";
        ...
        try     {
            DedicatedService ds = (DedicatedService) session.get(DedicatedService.class,dedicatedServiceID);
            session.delete(ds);
            t.commit();
            msg=SUCCESS;
        }
    ...
    public String Modify(Integer dedicatedServiceID,Integer serviceID,Integer techinicianID,double price)
    {
        String msg = "";
        DedicatedService result=null;
        Transaction t = session.beginTransaction();
        try     {
            DedicatedService ds = (DedicatedService) session.get(DedicatedService.class,dedicatedServiceID);
            Technician tech = (Technician) session.get(Technician.class,techinicianID);
            Service s = (Service) session.get(Service.class,serviceID);
            ds.setPrice(price);
            ds.setService(s);
