...
public class MemberShipCardLevelServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public MemberShipCardLevelServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		MemberShipCardLevelController c = new MemberShipCardLevelController ();
		...
		case "modify": {
			...
			result = c.modify(levelID, levelName);
